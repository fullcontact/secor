...
//Direct link: https://github.com/apache/parquet-mr/blob/apache-parquet-1.12.2/parquet-protobuf/src/main/java/org/apache/parquet/proto/ProtoParquetWriter.java
...
public class WriteCompliantProtoParquetWriter<T extends MessageOrBuilder> extends ParquetWriter<T> {
    ...
    /**
     * Create a new {@link WriteCompliantProtoParquetWriter}.
     *
     ...
     */
    public WriteCompliantProtoParquetWriter(Path file, Class<? extends Message> protoMessage,
                              CompressionCodecName compressionCodecName, int blockSize,
                              int pageSize) throws IOException {
        // using write compliant parquet writer
        super(file, new WriteCompliantProtoWriteSupport(protoMessage),
    ...
    /**
     * Create a new {@link WriteCompliantProtoParquetWriter}. The default block size is 50 MB.The default
    ...
    private static <T extends MessageOrBuilder> WriteSupport<T> writeSupport(Class<? extends Message> protoMessage) {
        // using write compliant parquet writer
        return new WriteCompliantProtoWriteSupport<T>(protoMessage);
    }
    ...
    public static class Builder<T> extends ParquetWriter.Builder<T, Builder<T>> {
        ...
        protected WriteSupport<T> getWriteSupport(Configuration conf) {
            return (WriteSupport<T>) WriteCompliantProtoParquetWriter.writeSupport(protoMessage);
        }
    }
}
