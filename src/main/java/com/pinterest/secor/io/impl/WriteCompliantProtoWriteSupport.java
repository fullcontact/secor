...
// Direct link: https://github.com/apache/parquet-mr/blob/apache-parquet-1.12.2/parquet-protobuf/src/main/java/org/apache/parquet/proto/ProtoWriteSupport.java
...
public class WriteCompliantProtoWriteSupport<T extends MessageOrBuilder> extends WriteSupport<T> {
    ...
    // force this to true: always want protos written to be compliant to they are usable
    // in spark, athena, etc.
    ...
    public WriteCompliantProtoWriteSupport() {
    }
    ...
    class FieldWriter {
        ...
        void writeField(Object value) {
            if (!(this instanceof WriteCompliantProtoWriteSupport.MapWriter)) {
